...
public class ConsumerTest {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        DslPart requestBody = new PactDslJsonBody()
                .numberType("id", 7001)
                .stringType("firstName", "Puja")
                .stringType("lastName", "Gorde")
                .stringType("email", "pujag@example.com");
    ...
    public void postRequestTest(){
        ...
        reqBody.put("id", 7001);
        reqBody.put("firstName", "Puja"); // Correct the key to match Pact
        reqBody.put("lastName", "Gorde"); // Correct the key to match Pact
        reqBody.put("email", "pujag@example.com");
